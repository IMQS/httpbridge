...
func TxFrameStart(builder *flatbuffers.Builder) { builder.StartObject(7) }
...
func TxFrameAddFlags(builder *flatbuffers.Builder, flags byte) { builder.PrependByteSlot(2, flags, 0) }
func TxFrameAddChannel(builder *flatbuffers.Builder, channel uint64) { builder.PrependUint64Slot(3, channel, 0) }
func TxFrameAddStream(builder *flatbuffers.Builder, stream uint64) { builder.PrependUint64Slot(4, stream, 0) }
func TxFrameAddHeaders(builder *flatbuffers.Builder, headers flatbuffers.UOffsetT) { builder.PrependUOffsetTSlot(5, flatbuffers.UOffsetT(headers), 0) }
...
func TxFrameAddBody(builder *flatbuffers.Builder, body flatbuffers.UOffsetT) { builder.PrependUOffsetTSlot(6, flatbuffers.UOffsetT(body), 0) }
